    ...
    void change_grip_status(float robot_ground_angle_before_attachment) {
        ...
        if (grip_mode) {
            ...
            for (int i = 0; i < Box::Box_Get_Adress(2, 0).size(); i++) {
                int count_side_greater = 0;
                if (sqrt((((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('a')->get_point_x()) * ((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('a')->get_point_x())) + (((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('a')->get_point_y()) * ((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('a')->get_point_y()))) > Box::Box_Get_Adress(2, 0)[i]->box_Get_Size('h')) {count_side_greater++; };
                if (sqrt((((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('b')->get_point_x()) * ((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('b')->get_point_x())) + (((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('b')->get_point_y()) * ((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('b')->get_point_y()))) > Box::Box_Get_Adress(2, 0)[i]->box_Get_Size('h')) {count_side_greater++; };
                if (sqrt((((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('c')->get_point_x()) * ((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('c')->get_point_x())) + (((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('c')->get_point_y()) * ((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('c')->get_point_y()))) > Box::Box_Get_Adress(2, 0)[i]->box_Get_Size('h')) {count_side_greater++; };
                if (sqrt((((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('d')->get_point_x()) * ((*this).grip_collision_point()->get_point_x() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('d')->get_point_x())) + (((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('d')->get_point_y()) * ((*this).grip_collision_point()->get_point_y() - Box::Box_Get_Adress(2, 0)[i]->box_get_point('d')->get_point_y()))) > Box::Box_Get_Adress(2, 0)[i]->box_Get_Size('h')) {count_side_greater++; };
                if (count_side_greater < 2) {
